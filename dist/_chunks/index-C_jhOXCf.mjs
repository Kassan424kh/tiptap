...
const index = {
  register(app) {
    app.addMenuLink({
      ...
      Component: async () => {
        const { App } = await import("./App-BNN8zVnC.mjs");
        return App;
      }
    });
    app.registerPlugin({
    ...
    app.customFields.register({
      ...
      components: {
        Input: async () => import("./TipTapInput-DPsRWi54.mjs")
      }
    });
  },
